...
{    
    ...
    void RefreshVSyncDisplay()
    {
        graphicsdropdowns[3].value = vSyncIndex;
        graphicsdropdowns[3].RefreshShownValue();
    }
    public void SetVSyncValue(int index)
    {
        if (vSyncIndex != index)
        {
            vSyncIndex = index;
    ...
    public void SetAll(GameData data){
        ...
        vSyncIndex = data.qualityVSyncIndex;
        FullcreenCheck();
